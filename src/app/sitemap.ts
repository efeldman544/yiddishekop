...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/browse`,              lastModified: new Date(), changeFrequency: 'daily',   priority: 0.95 },
    { url: `${base}/for-candidates`,      lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    ...
    { url: `${base}/start-hiring`,        lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
