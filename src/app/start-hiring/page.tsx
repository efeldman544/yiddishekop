          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18 }}>
              <div>
                ...
                <input
                  ...
                  placeholder="Sara Klein" className="auth-input"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder="Acme Corp" className="auth-input"
                />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 18 }}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="631 494 3567" className="auth-input"
                />
              </div>
            </div>
            ...
            <div style={{ borderTop: '1px solid var(--lp-line)', paddingTop: 22 }}>
              <div>
                ...
                <input
                  type="text" required value={form.role_title}
                  onChange={e => set('role_title', e.target.value)}
                  placeholder="e.g. Bookkeeper, Admin Assistant, Sales Rep…" className="auth-input"
                />
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 18 }}>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 40" className="auth-input"
                />
              </div>
              <div>
                <label className="auth-label">Salary budget</label>
                <input
                  type="text" value={form.salary}
                  onChange={e => set('salary', e.target.value)}
                  placeholder="e.g. $18–22/hr" className="auth-input"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                placeholder="Describe the day-to-day responsibilities, required skills, and what a great fit looks like for your business…"
